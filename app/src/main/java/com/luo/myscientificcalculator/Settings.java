    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked){
                    Toast.makeText(Settings.this,"手动输入模式开",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(Settings.this,"手动输入模式关",Toast.LENGTH_SHORT).show();
                }
        ...
        sw_vibrate.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                editor = getSharedPreferences("data_num",MODE_PRIVATE).edit();
                if(isChecked){
                    Toast.makeText(Settings.this,"触摸反馈开",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(Settings.this,"触摸反馈关",Toast.LENGTH_SHORT).show();
                }
